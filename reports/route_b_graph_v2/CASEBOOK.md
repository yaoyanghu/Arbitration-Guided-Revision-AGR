...
- `v2_001_mixed`: Route A final `2` -> graph `1`
  ...
  edge counts: {'support': 2, 'corroborate': 3, 'update': 1, 'contradict': 2}
...
- `v2_001_clear`: edge count `5`, edge counts `{'support': 1, 'corroborate': 1, 'update': 1, 'contradict': 2}`
  query: As of 2021, Joe Biden is the president of the United States.
- `v2_001_reliability`: edge count `5`, edge counts `{'support': 2, 'corroborate': 2, 'contradict': 1}`
...
- `v2_001_mixed`: edge count `8`, edge counts `{'support': 2, 'corroborate': 3, 'update': 1, 'contradict': 2}`
  query: Before the update was fully settled, joe biden was a former vice president and presidential candidate, not yet serving as president By 2021, what was the current status of Joe Biden in the official current record?
- `v2_002_clear`: edge count `5`, edge counts `{'support': 1, 'corroborate': 1, 'update': 1, 'contradict': 2}`
  query: As of 2023, Lionel Messi plays for Inter Miami.
- `v2_002_reliability`: edge count `5`, edge counts `{'support': 2, 'corroborate': 2, 'contradict': 1}`
